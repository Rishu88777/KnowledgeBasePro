...
export default function DocumentList({ 
  ...
  const { documents: allDocuments, searchQuery, deleteDocument } = useApp();
  
  const documentsToShow = propDocuments || allDocuments;
  
  const filteredDocuments = useMemo(() => {
    if (!searchQuery) return documentsToShow;
